...
public class PowerOfNumbers {
    ...
    private static long calculateModulo(int N, int R) {
        // Base cases
        if (N == 0) {
            return 0;
        }
        ...
        // If R is odd
            ...
            res = (res * calculateModulo(N, R - 1) % 1000000007) % 1000000007;
        }
    ...
    public static long power(int N, int R) {
        return calculateModulo(N, R) % 1000000007;
    }
}
