...
public class IndexOfLastOccurrenceInSorted {
  ...
  /**
   * Iteratively searches for the last occurrence of a specified number in a sorted integer array.
   *
   * @param arr The sorted array in which to search.
   * @param num The number to search for.
   * @return The index of the last occurrence of the specified number in the array, or -1 if the number is not found.
   */
  static int searchIterative(int[] arr, int num) {
    ...
    while (start <= end) {
      ...
      if (arr[mid] == num) {
        // Check if it's the last occurrence by comparing with the next element.
        // If it's the last occurrence, return its index.
        // Otherwise, continue searching in the right half of the array by updating the 'start' index.
  ...
  /**
   * Recursively searches for the last occurrence of a specified number in a sorted integer array.
   *
   * @param arr   The sorted array in which to search.
   * @param num   The number to search for.
  ...
  static int searchRecursive(int[] arr, int num, int start, int end) {
    ...
    if (arr[mid] == num) {
      // Check if it's the last occurrence by comparing with the next element.
      // If it's the last occurrence, return its index.
      // Otherwise, continue searching in the right half of the array.
